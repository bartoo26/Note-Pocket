class NoteView {
    show(note) {
        ...
        $('#notes').append(
                '<article id="' + note.id + '" class="note ' + note.color + '">'
    ...
    toEdit(note) {
        ...
        $('#' + note.id).append(
                ...
                + '<p>'
                + '<input type="radio" id="edit-note-white-' + note.id + '" name="edit-color-' + note.id + '" class="note-form-color-radio" value="note-white">'
                + '<label for="edit-note-white-' + note.id + '"  class="note-form-color-label">White<span class="note-white note-form-color"></span></label>'
                + '<input type="radio" id="edit-note-red-' + note.id + '" name="edit-color-' + note.id + '" class="note-form-color-radio" value="note-red">'
                + '<label for="edit-note-red-' + note.id + '" class="note-form-color-label">Red<span class="note-red note-form-color"></span></label>'
                + '<input type="radio" id="edit-note-yellow-' + note.id + '" name="edit-color-' + note.id + '" class="note-form-color-radio"  value="note-yellow">'
                + '<label for="edit-note-yellow-' + note.id + '" class="note-form-color-label">Yellow<span class="note-yellow note-form-color"></span></label>'
                + '</p>'
